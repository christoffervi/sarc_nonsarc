...
fig4_df<-
  rbind(
    #Obesity
    #  chris_hr_time_interaction2srt(dfposneg, pid, echo_age0, t2_obesity, event_obesity, t2_obstruction, event_obstruction,sarc_status, 'age', F),
    chris_hr_time_interaction2srt(dfposneg, pid, first_encounter_age, t2_obesity, event_obesity, t2_nyha_hf, event_nyha_hf,sarc_status, 'age', F),
    #chris_hr_time_interaction2srt(dfposneg, pid, first_encounter_age, t2_obesity, event_obesity, t2_af, event_af,sarc_status, 'age', F),
    #    chris_hr_time_interaction2srt(dfposneg, pid, first_encounter_age, t2_obesity, event_obesity, t2_death, event_death,sarc_status, 'age', F),
    
    #Hypertension
    #    chris_hr_time_interaction2srt(dfposneg, pid, echo_age0, t2_htn, event_htn, t2_obstruction, event_obstruction,sarc_status, 'age', F),
    #    chris_hr_time_interaction2srt(dfposneg, pid, first_encounter_age, t2_htn, event_htn, t2_af, event_af,sarc_status, 'age', F),
    
    # LV Obstruction
    chris_hr_time_interaction2srt(dfposneg, pid, first_encounter_age, t2_obstruction, event_obstruction, t2_nyha_hf, event_nyha_hf,sarc_status, 'age', F),
    chris_hr_time_interaction2srt(dfposneg, pid, first_encounter_age, t2_obstruction, event_obstruction, t2_af, event_af,sarc_status, 'age', F),
    chris_hr_time_interaction2srt(dfposneg, pid, first_encounter_age, t2_obstruction, event_obstruction, t2_vt, event_vt,sarc_status, 'age', F),
    
    #AF
    #  chris_hr_time_interaction2srt(dfposneg, pid, echo_age0, t2_af, event_af, t2_obstruction, event_obstruction,sarc_status, 'age', F),
    chris_hr_time_interaction2srt(dfposneg, pid, first_encounter_age, t2_af, event_af, t2_nyha_hf, event_nyha_hf,sarc_status, 'age', F),
    chris_hr_time_interaction2srt(dfposneg, pid, echo_age0, t2_af, event_af, t2_lvsd, event_lvsd,sarc_status, 'age', F),
    chris_hr_time_interaction2srt(dfposneg, pid, first_encounter_age, t2_af, event_af, t2_vt, event_vt,sarc_status, 'age', F),
    chris_hr_time_interaction2srt(dfposneg, pid, first_encounter_age, t2_af, event_af, t2_stroke, event_stroke,sarc_status, 'age', F),
    chris_hr_time_interaction2srt(dfposneg, pid, first_encounter_age, t2_af, event_af, t2_htxvad, event_htxvad,sarc_status, 'age', F),
    chris_hr_time_interaction2srt(dfposneg, pid, first_encounter_age, t2_af, event_af, t2_death, event_death,sarc_status, 'age', F),
    
    # LVSD
    #  chris_hr_time_interaction2srt(dfposneg, pid, echo_age0, t2_lvsd, event_lvsd, t2_obstruction, event_obstruction,sarc_status, 'age', F),
    chris_hr_time_interaction2srt(dfposneg, pid, first_encounter_age, t2_lvsd, event_lvsd, t2_nyha_hf, event_nyha_hf,sarc_status, 'age', F),
    chris_hr_time_interaction2srt(dfposneg, pid, first_encounter_age, t2_lvsd, event_lvsd, t2_vt, event_vt,sarc_status, 'age', F),
    #    chris_hr_time_interaction2srt(dfposneg, pid, first_encounter_age, t2_lvsd, event_lvsd, t2_stroke, event_stroke,sarc_status, 'age', F),
    chris_hr_time_interaction2srt(dfposneg, pid, first_encounter_age, t2_lvsd, event_lvsd, t2_htxvad, event_htxvad,sarc_status, 'age', F),
    chris_hr_time_interaction2srt(dfposneg, pid, first_encounter_age, t2_lvsd, event_lvsd, t2_death, event_death,sarc_status, 'age', F)
  ) %>%
  ...
  right_join(
    ...
    rbind(
      #Obesity
      chris_hr_time_interaction(dfposneg, pid, echo_age0, t2_obesity, event_obesity, t2_obstruction, event_obstruction,sarc_status, 'age', F, t2_srt = t2_srt, event_srt = event_srt),
      ...
      #Hypertension
      chris_hr_time_interaction(dfposneg, pid, echo_age0, t2_htn, event_htn, t2_obstruction, event_obstruction,sarc_status, 'age', F, t2_srt = t2_srt, event_srt = event_srt),
      ...
      chris_hr_time_interaction(dfposneg, pid, first_encounter_age, t2_af, event_af, t2_af, event_af,sarc_status, 'age', F, t2_srt = t2_srt, event_srt = event_srt),
      chris_hr_time_interaction(dfposneg, pid, echo_age0, t2_af, event_af, t2_lvsd, event_lvsd,sarc_status, 'age', F, t2_srt = t2_srt, event_srt = event_srt),
