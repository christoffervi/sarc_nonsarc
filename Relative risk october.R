...
rbind(
  calculate_rr_age(dfposneg, age_obesity, age_htn,bf_cor, T),
  calculate_rr_age(dfposneg, age_obesity, age_obstruction,bf_cor, T),
  calculate_rr_age(dfposneg, age_obesity, age_nyha_hf,bf_cor, T),
  calculate_rr_age(dfposneg, age_obesity, age_af,bf_cor, T),
  calculate_rr_age(dfposneg, age_obesity, age_vt,bf_cor, T),
  calculate_rr_age(dfposneg, age_obesity, age_stroke,bf_cor, T),
  calculate_rr_age(dfposneg, age_obesity, age_death,bf_cor, T),
  calculate_rr_age(dfposneg, age_obesity, age_htxvad,bf_cor, T),
  calculate_rr_age(dfposneg, age_obesity, age_lvsd,bf_cor, T),
  ...
  calculate_rr_age(dfposneg, age_htn, age_death,bf_cor, T),
  ...
  calculate_rr_age(dfposneg, age_obstruction, age_death,bf_cor, T),
  ...
  calculate_rr_age(dfposneg, age_af, age_death,bf_cor, T),
  ...
  calculate_rr_age(dfposneg, age_nyha_hf, age_death,bf_cor, T),
  ...
  calculate_rr_age(dfposneg, age_lvsd, age_death,bf_cor, T),
  ...
  calculate_rr_age(dfposneg, age_vt, age_death,bf_cor, T),
...
x<-
  ...
  ggsci::scale_fill_material(breaks = seq(0,40,10))+
...
x
ggsave(filename = "Relative risk (co-occurence).pdf", device = cairo_pdf, height = 16, width = 20, units = "cm", dpi =3300)
