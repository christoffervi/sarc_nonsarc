...
ggsave(filename = "Figure 4 october 2023.pdf", device = cairo_pdf, height = 16, width = 20, units = "cm", dpi =2900)
...
rbind(
  ...
  select(term, outcome, effect = estimate, t_stat = statistic) %>% 
  right_join(
    ...
    #hr_df<-
    rbind(
      chris_hr_time_interaction2(dfposneg, pid, first_encounter_age, t2_obesity, event_obesity, t2_af, event_af,sarc_status, 'age'),
      
      chris_hr_time_interaction2(dfposneg, pid, first_encounter_age, t2_htn, event_htn, t2_obstruction, event_obstruction, sarc_status, 'age'),
      
      chris_hr_time_interaction2(dfposneg, pid, first_encounter_age, t2_obstruction, event_obstruction, t2_af, event_af,sarc_status, 'age'),
      chris_hr_time_interaction2(dfposneg, pid, first_encounter_age, t2_af, event_af, t2_nyha_hf, event_nyha_hf,sarc_status, 'age'),
      chris_hr_time_interaction2(dfposneg, pid, first_encounter_age, t2_af, event_af, t2_lvsd, event_lvsd,sarc_status, 'age'),
      chris_hr_time_interaction2(dfposneg, pid, first_encounter_age, t2_af, event_af, t2_vt, event_vt,sarc_status, 'age'),
      chris_hr_time_interaction2(dfposneg, pid, first_encounter_age, t2_af, event_af, t2_death, event_death,sarc_status, 'age'),
      chris_hr_time_interaction2(dfposneg, pid, first_encounter_age, t2_nyha_hf, event_nyha_hf, t2_obstruction, event_obstruction,sarc_status, 'age'),
      chris_hr_time_interaction2(dfposneg, pid, first_encounter_age, t2_nyha_hf, event_nyha_hf, t2_af, event_af,sarc_status, 'age'),
      chris_hr_time_interaction2(dfposneg, pid, first_encounter_age, t2_nyha_hf, event_nyha_hf, t2_death, event_death,sarc_status, 'age'),
      chris_hr_time_interaction2(dfposneg, pid, first_encounter_age, t2_nyha_hf, event_nyha_hf, t2_htxvad, event_htxvad,sarc_status, 'age'),
      chris_hr_time_interaction2(dfposneg, pid, first_encounter_age, t2_lvsd, event_lvsd, t2_nyha_hf, event_nyha_hf,sarc_status, 'age'),
      chris_hr_time_interaction2(dfposneg, pid, first_encounter_age, t2_lvsd, event_lvsd, t2_vt, event_vt,sarc_status, 'age'),
  ...
  filter(outcome!= "Hypertension", exposure != 'NYHA III-IV') %>% 
  #  mutate(size = if_else(!is.na(vuffi),1,0),
  #        p_rank = rank(-p)^4) %>% 
  ggplot(aes(x=outcome, y=exposure, 
  ...
  facet_wrap(~sarc)
ggsave(filename = "cox_fig_main_combined effect1.pdf", device = cairo_pdf, height = 13, width = 32, units = "cm", dpi =2900)
