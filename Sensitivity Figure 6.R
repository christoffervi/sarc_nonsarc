...
fig4_df<-
  rbind(
    #Obesity
    #  chris_hr_time_interaction2(dfposnegproband, pid, echo_age0, t2_obesity, event_obesity, t2_obstruction, event_obstruction,sarc_status, 'age', F),
    chris_hr_time_interaction2(dfposnegproband, pid, first_encounter_age, t2_obesity, event_obesity, t2_nyha_hf, event_nyha_hf,sarc_status, 'age', F),
    chris_hr_time_interaction2(dfposnegproband, pid, first_encounter_age, t2_obesity, event_obesity, t2_af, event_af,sarc_status, 'age', F),
    #    chris_hr_time_interaction2(dfposnegproband, pid, first_encounter_age, t2_obesity, event_obesity, t2_death, event_death,sarc_status, 'age', F),
    
    #Hypertension
    #    chris_hr_time_interaction2(dfposnegproband, pid, echo_age0, t2_htn, event_htn, t2_obstruction, event_obstruction,sarc_status, 'age', F),
    #    chris_hr_time_interaction2(dfposnegproband, pid, first_encounter_age, t2_htn, event_htn, t2_af, event_af,sarc_status, 'age', F),
    
    # LV Obstruction
    chris_hr_time_interaction2(dfposnegproband, pid, first_encounter_age, t2_obstruction, event_obstruction, t2_nyha_hf, event_nyha_hf,sarc_status, 'age', F),
    chris_hr_time_interaction2(dfposnegproband, pid, first_encounter_age, t2_obstruction, event_obstruction, t2_af, event_af,sarc_status, 'age', F),
    chris_hr_time_interaction2(dfposnegproband, pid, first_encounter_age, t2_obstruction, event_obstruction, t2_vt, event_vt,sarc_status, 'age', F),
    
    #AF
    #  chris_hr_time_interaction2(dfposnegproband, pid, echo_age0, t2_af, event_af, t2_obstruction, event_obstruction,sarc_status, 'age', F),
    chris_hr_time_interaction2(dfposnegproband, pid, first_encounter_age, t2_af, event_af, t2_nyha_hf, event_nyha_hf,sarc_status, 'age', F),
    chris_hr_time_interaction2(dfposnegproband, pid, echo_age0, t2_af, event_af, t2_lvsd, event_lvsd,sarc_status, 'age', F),
    chris_hr_time_interaction2(dfposnegproband, pid, first_encounter_age, t2_af, event_af, t2_vt, event_vt,sarc_status, 'age', F),
    chris_hr_time_interaction2(dfposnegproband, pid, first_encounter_age, t2_af, event_af, t2_stroke, event_stroke,sarc_status, 'age', F),
    chris_hr_time_interaction2(dfposnegproband, pid, first_encounter_age, t2_af, event_af, t2_htxvad, event_htxvad,sarc_status, 'age', F),
    chris_hr_time_interaction2(dfposnegproband, pid, first_encounter_age, t2_af, event_af, t2_death, event_death,sarc_status, 'age', F),
  ...
  right_join(
    ...
    rbind(
     ...
     # chris_hr_time_interaction(dfposnegproband, pid, echo_age0, t2_obesity, event_obesity, t2_obstruction, event_obstruction,sarc_status, 'age', F),
      ...
      # LV Obstruction
      chris_hr_time_interaction(dfposnegproband, pid, first_encounter_age, t2_obstruction, event_obstruction, t2_nyha_hf, event_nyha_hf,sarc_status, 'age', F),
      chris_hr_time_interaction(dfposnegproband, pid, first_encounter_age, t2_obstruction, event_obstruction, t2_af, event_af,sarc_status, 'age', F),
      chris_hr_time_interaction(dfposnegproband, pid, first_encounter_age, t2_obstruction, event_obstruction, t2_vt, event_vt,sarc_status, 'age', F),
      
      #AF
      #  chris_hr_time_interaction2(dfposnegproband, pid, echo_age0, t2_af, event_af, t2_obstruction, event_obstruction,sarc_status, 'age', F),
      chris_hr_time_interaction(dfposnegproband, pid, first_encounter_age, t2_af, event_af, t2_nyha_hf, event_nyha_hf,sarc_status, 'age', F),
      chris_hr_time_interaction(dfposnegproband, pid, first_encounter_age, t2_af, event_af, t2_af, event_af,sarc_status, 'age', F),
      chris_hr_time_interaction(dfposnegproband, pid, echo_age0, t2_af, event_af, t2_lvsd, event_lvsd,sarc_status, 'age', F),
      chris_hr_time_interaction(dfposnegproband, pid, first_encounter_age, t2_af, event_af, t2_vt, event_vt,sarc_status, 'age', F),
      chris_hr_time_interaction(dfposnegproband, pid, first_encounter_age, t2_af, event_af, t2_stroke, event_stroke,sarc_status, 'age', F),
      chris_hr_time_interaction(dfposnegproband, pid, first_encounter_age, t2_af, event_af, t2_htxvad, event_htxvad,sarc_status, 'age', F),
      chris_hr_time_interaction(dfposnegproband, pid, first_encounter_age, t2_af, event_af, t2_death, event_death,sarc_status, 'age', F),
...
fig4_df %>% 
  ...
  ggplot(aes(y=.est, x=exposure_outcome, ymin = .lower, ymax = .upper, group = sarc ,
             ...
             label = vuffi_label))+
  labs(title = 'Interactions between genetic status and **exposures** on *outcomes*, excluding patients diagnosed through screening',
       x='**Exposures and outcomes**',
       y = '**Hazard ratio** <br> Combined effect of genetic status and exposure')+
  annotate('text', x = 9.5, y = c(8 , 24), label = c('Effect ratio', 'P for interaction'),
  ...
  geom_segment(aes(y = 1, yend = 1, x= 0.6, xend = 9.6), color = 'black', linetype = 2)+
...
ggsave(filename = 'Sup Figure6_2025_03_06.pdf', device = cairo_pdf , height = 6.3, width = 8, units = "in", dpi =1000)
