...
p1<-
  ...
  coord_cartesian(xlim = c(.6,6.4), ylim = c(1.25,60), expand = F, clip = "off")+
  annotate("text", x= c(5.13,4.87), y = c(45.955677,34.331150),
...
p4<-
  ...
  theme(panel.background = element_rect(fill = "white"),
        ...
        axis.text.x = element_text(family = "Helvetica", size = 10),
        axis.text.y = element_text(family = "Helvetica", size = 10))+
  annotate("text", x= .5,y=.06, hjust =0, family = "Helvetica",
...
ggsave(filename = "death_age_log.tiff", compression = "lzw", height = 26, width = 20, units = "cm", dpi =900)
...
setwd("~/Dropbox/10 R/non-genetic hcm/sarc_nonsarc/")
